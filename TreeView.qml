...
Rectangle{
    ...
    //背景
    color: Qt.rgba(2/255,19/255,23/255,0/255)
    border.color: "#d7e45f"
                    ...
                    Rectangle{
                        ...
                        MouseArea{
                            ...
                            onClicked: {
                                ...
                                console.log("selected",list_itemrow.itemIndex, "(", list_itemrow.indexArray, ")")
                            }
                        }
                        ...
                        Row {
                            ...
                            IconImage {
                                ...
                                source: {
                                    ...
                                    case "ellipse":
                                        return currentItem===list_itemrow.itemIndex?"img/ellipse_selected.svg": "img/ellipse.svg"
                                    case "polygon":
                                        return currentItem===list_itemrow.itemIndex?"img/polygon_selected.svg": "img/polygon.svg"
                                    case "curve":
                                        return currentItem===list_itemrow.itemIndex?"img/curve_selected.svg": "img/curve.svg"
                                    }
                                }
                            }
